...
static bool	append_subshell_redirects(t_context *ctx, t_ast_node *node, t_list **tokens)
{
...
static bool	append_command_element(t_context *ctx, t_simple_command *cmd, t_list **tokens)
{
